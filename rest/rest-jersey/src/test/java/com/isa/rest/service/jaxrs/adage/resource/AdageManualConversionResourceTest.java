...
public class AdageManualConversionResourceTest extends JerseyTest {

  private static final String MANUAL_RESOURCE = "/manual";

  private static final String MANUAL_RESOURCE_JSON = "/manual/json";

  private static final String MANUAL_RESOURCE_PLAIN = "/manual/plain";
  ...
  public void shouldGetAdage_WithXmlRepresentation_WithDefaultAcceptHeader() {
    Response response = target(MANUAL_RESOURCE).request().get();
  ...
  public void shouldGetAdage_WithXmlRepresentation_WhenXmlIsRequested() {
    Response response = target(MANUAL_RESOURCE).request(MediaType.APPLICATION_XML).get();
  ...
  public void shouldNotGetAdage_WithXmlRepresentation_WhenJsonIsRequested() {
    Response response = target(MANUAL_RESOURCE).request(MediaType.APPLICATION_JSON).get();
  ...
  public void shouldGetAdage_WithJsonRepresentation_WithDefaultAcceptHeader() {
    Response response = target(MANUAL_RESOURCE_JSON).request().get();
  ...
  public void shouldGetAdage_WithJsonRepresentation_WhenJsonIsRequested() {
    Response response = target(MANUAL_RESOURCE_JSON).request(MediaType.APPLICATION_JSON).get();
  ...
  public void shouldNotGetAdage_WithJsonRepresentation_WhenXmlIsRequested() {
    Response response = target(MANUAL_RESOURCE_JSON).request(MediaType.APPLICATION_XML).get();
  ...
  public void shouldNotGetAdage_WithJsonRepresentation_WhenPlainTextIsRequested() {
    Response response = target(MANUAL_RESOURCE_JSON).request(MediaType.TEXT_PLAIN).get();
  ...
  public void shouldGetAdage_WithPlainTextRepresentation_WithDefaultAcceptHeader() {
    Response response = target(MANUAL_RESOURCE_PLAIN).request().get();
  ...
  public void shouldGetAdage_WithPlainTextRepresentation_WhenPlainTextIsRequested() {
    Response response = target(MANUAL_RESOURCE_PLAIN).request(MediaType.TEXT_PLAIN).get();
  ...
  public void shouldNotGetAdage_WithPlainTextRepresentation_WhenXmlIsRequested() {
    Response response = target(MANUAL_RESOURCE_PLAIN).request(MediaType.APPLICATION_XML).get();
  ...
  public void shouldNotGetAdage_WithPlainTextRepresentation_WhenJsonIsRequested() {
    Response response = target(MANUAL_RESOURCE_PLAIN).request(MediaType.APPLICATION_JSON).get();
