package com.isa.ws.client.jersey;
...
public class JerseyClient {
	private static final String baseUrl = "http://localhost:8089/predictions/servlet";
	...
	private void postDemo(WebResource resource) {
		...
		String response = resource.type(MediaType.APPLICATION_FORM_URLENCODED_TYPE).accept(MediaType.TEXT_PLAIN_TYPE).post(String.class, form);
		report("POST:\n", response);
	}
