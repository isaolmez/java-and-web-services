...
public class ObjectFactory {
    ...
    private final static QName _Next1_QNAME = new QName("http://take2.chapter4.ws.isa.com/", "next1");
    private final static QName _Next1Response_QNAME = new QName("http://take2.chapter4.ws.isa.com/", "next1Response");
    private final static QName _NextN_QNAME = new QName("http://take2.chapter4.ws.isa.com/", "nextN");
    private final static QName _NextNResponse_QNAME = new QName("http://take2.chapter4.ws.isa.com/", "nextNResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://take2.chapter4.ws.isa.com/", name = "next1")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://take2.chapter4.ws.isa.com/", name = "next1Response")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://take2.chapter4.ws.isa.com/", name = "nextN")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://take2.chapter4.ws.isa.com/", name = "nextNResponse")
